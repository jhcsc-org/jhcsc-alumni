      ...
      {isOpen && (
        <>
          <motion.div
            ...
            className='fixed inset-0 w-full h-full bg-foreground/70 backdrop-blur-sm dark:bg-black/40'
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          />
...
export {
    Dialog as MotionDialog, DialogClose as MotionDialogClose, DialogContainer as MotionDialogContainer,
    DialogContent as MotionDialogContent, DialogDescription as MotionDialogDescription,
    DialogImage as MotionDialogImage, DialogSubtitle as MotionDialogSubtitle, DialogTitle as MotionDialogTitle, DialogTrigger as MotionDialogTrigger
};
